...
const Contact = () => {
  ...
  return (
    <>
      {/* <!-- ===== Contact Start ===== --> */}
      <section id="privacy-policy" className="px-4 md:px-8 2xl:px-0">
        <div className="relative mx-auto max-w-c-1390 px-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20 policy">
          <div>
            <div></div>
            <div>
              <h1>Privacy Policy</h1>
              <p>Updated at 2024-11-17</p>
            </div>
          </div>
          <div>
            <p> Outlaine (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Outlaine.</p>
            <div><p>  Outlaine (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Outlaine.</p> <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, Outlaine. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service. </p></div>
          </div>
          <div>
            <div></div>
            <div><h1>Definitions and key terms</h1></div>
          </div>
          <div>
            <p>Explain Def</p>
            <div>
              ...
              <ul>
                ...
                <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Outlaine, that is responsible for your information under this Privacy Policy.</li>
                <li>Country: where Outlaine or the owners/founders of Outlaine are based, in this case is Germany</li>
                <li>Customer: refers to the company, organization or person that signs up to use the Outlaine Service to manage the relationships with your consumers or service users.</li>
                <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Outlaine and use the services.</li>
                ...
                <li>Personnel: refers to those individuals who are employed by Outlaine or are under contract to perform a service on behalf of one of the parties.</li>
                ...
                <li>Service: refers to the service provided by Outlaine as described in the relative terms (if available) and on this platform.</li>
                ...
                <li>Website: Outlaine's site, which can be accessed via this URL: </li>
                <li>You: a person or entity that is registered with Outlaine to use the Services.</li>
              </ul>
            </div>
          </div>
          <div><div></div>
            <div>
              <h1 className="text-2xl font-semibold mt-8 mb-4">What Information Do We Collect?</h1>
            </div>
          </div>
          <div>
            <p>Explain collected info</p>

            <div><p>We collect information from you when you visit our app, register on our site, place an order, subscribe to our newsletter, respond to a survey or fill out a form.</p>
          ...
          <div>
            <div></div>
            <div><h1>How Do We Use The Information We Collect?</h1></div>
          </div>
          <div>
            <p>Def personalisation</p>
            <div>
          ...
          <div>
            <p>End user def</p>
            <div>
              <h1>When does Outlaine use end user information from third parties?</h1>
              <p>Outlaine will collect End User Data necessary to provide the Outlaine services to our customers.</p>
          ...
          <div>
            <p>Def third party</p>
            <div>
              <h1>When does Outlaine use customer information from third parties?</h1>
              <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a Outlaine customer, we receive information from a third party that provides automated fraud detection services to Outlaine. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
            </div>
          </div>
          <div>
            <div></div>
          ...
          <div>
            <p>Def share infos with third party</p>
            <div>
          ...
          <div>
            <p>asdasdfgdfgd</p>
            <p>Outlaine will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
          </div>
          <div>
            <div></div>
            <div>
          ...
          <div>
            ...
            <div><h1>Can I update or correct my information?</h1></div>
          </div>
          <div>
            <p>infoa sdas</p>
            <p>The rights you have to request updates or corrections to the information Outlaine collects depend on your relationship with Outlaine. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
          </div>
          <div>
            <p>infoa sdas</p>
          ...
          <div>
            <p>infoa sdas</p>
            <div><h1>Sale of Business</h1></div>
          </div>
          <div>
            <p>infoa sdas</p>
            <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Outlaine or any of its Corporate Affiliates (as defined herein), or that portion of Outlaine or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>
          </div>
          <div>
            <p>infoa sdas</p>
          ...
          <div>
            <p>infoa sdas</p>
            <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with Outlaine, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p></div>
          <div>
            <p>infoa sdas</p>
          ...
          <div>
            <p>infoa sdas</p>
            <p>This Privacy Policy is governed by the laws of Germany without regard to its conflict of laws provision. You consent to the exclusive jurisdiction of the courts in connection with any action or dispute arising between the parties under or in connection with this Privacy Policy except for those individuals who may have rights to make claims under Privacy Shield, or the Swiss-US framework.</p>
          </div>
          <div>
            <p>infoa sdas</p>
            <p>The laws of Germany, excluding its conflicts of law rules, shall govern this Agreement and your use of the app. Your use of the app may also be subject to other local, state, national, or international laws.</p>
          </div>
          <div>
            <p>infoa sdas</p>
            <p>By using Outlaine or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or disclosure of your personal information will mean that you accept those changes.</p></div>
          <div>
            <p>infoa sdas</p>

            <div><h1>Your Consent</h1></div>
          </div>
          <div>
            <p>infoa sdas</p>
          ...
          <div>
            ...
            <div><h1>Blocking and disabling cookies and similar technologies</h1></div>
          </div>
          <div>
            <p>infoa sdas</p>
          ...
          <div>
            <p>infoa sdas</p>
            <div><h1>Changes To Our Privacy Policy</h1></div>
          </div>
          <div>
            <p>infoa sdas</p>
          ...
          <div>
            <p>infoa sdas</p>
            <div><h1>Third-Party Services</h1></div>
          </div>
          <div>
            <p>asdhjalksd</p>
          ...
          <div>
            <p>infoa sdas</p>
            <p>You acknowledge and agree that Outlaine shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. Outlaine does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.</p>
          </div>
          <div>
            <p>infoa sdas</p>
          ...
          <div>
            <p></p>
            <div><h1>Tracking Technologies</h1></div>
          </div>
          <div>
            <p>infoa sdas</p>
            <div>
          ...
          <div>
            <p></p>
            <div><h1>What is personal data?</h1></div>
          </div>
          <div>
            <p>infoa sdas</p>
          ...
          <div>
            <p>infoa sdas</p>
            <div><p>The Data Protection Principles include requirements such as:</p>
              <ul>
          ...
          <div>
            <p>infoa sdas</p>
            <p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that they collect and process. It also raises the stakes for compliance by increasing enforcement and imposing greater fines for breach. Beyond these facts it's simply the right thing to do. At Outlaine we strongly believe that your data privacy is very important and we already have solid security and privacy practices in place that go beyond the requirements of this new regulation.</p>
          </div>
          <div>
            <p></p>
            <div>
          ...
          <div>
            <p>infoa sdas</p>
            <div><p>CalOPPA users have the following rights:</p>
              <ul>
                <li>Right to Know and Access. You may submit a verifiable request for information regarding the: (1) categories of Personal Information we collect, use, or share; (2) purposes for which categories of Personal Information are collected or used by us; (3) categories of sources from which we collect Personal Information; and (4) specific pieces of Personal Information we have collected about you.</li>
                <li>Right to Equal Service. We will not discriminate against you if you exercise your privacy rights.</li>
                <li>Right to Delete. You may submit a verifiable request to close your account and we will delete Personal Information about you that we have collected.</li>
